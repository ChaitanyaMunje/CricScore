 ...
 */
public class Match3 extends Fragment {
    public Match3() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View v = inflater.inflate(R.layout.fragment_match3, container, false);


        final TextView toss=(TextView)v.findViewById(R.id.toss);
        final TextView score3=(TextView)v.findViewById(R.id.score3);
        ...
        final DocumentReference doccument=db.collection("Data").document("Match3");
        doccument.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@javax.annotation.Nullable DocumentSnapshot documentSnapshot, @javax.annotation.Nullable FirebaseFirestoreException e) {
                ...
                if (documentSnapshot !=null && documentSnapshot.exists()){
                    ...
                    score3.setText(documentSnapshot.getData().get("score").toString());
