...
public class Match1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View v = inflater.inflate(R.layout.fragment_match1, container, false);


        final TextView toss=(TextView)v.findViewById(R.id.toss);
        final TextView score=(TextView)v.findViewById(R.id.score1);
       ...
       final DocumentReference doccument=db.collection("Data").document("Match1");
