 ...
 */
public class Match2 extends Fragment {
    public Match2() {
        }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View v = inflater.inflate(R.layout.fragment_match2, container, false);


        final TextView toss=(TextView)v.findViewById(R.id.toss);
        final TextView score2=(TextView)v.findViewById(R.id.score2);
        ...
        final DocumentReference doccument=db.collection("Data").document("Match2");
        doccument.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@javax.annotation.Nullable DocumentSnapshot documentSnapshot, @javax.annotation.Nullable FirebaseFirestoreException e) {
                ...
                if (documentSnapshot !=null && documentSnapshot.exists()){
                   ...
                   score2.setText(documentSnapshot.getData().get("score").toString());
