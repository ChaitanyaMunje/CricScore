...
public class Match5 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View v = inflater.inflate(R.layout.fragment_match5, container, false);


        final TextView toss=(TextView)v.findViewById(R.id.toss);
        final TextView score=(TextView)v.findViewById(R.id.score5);
        ...
        final DocumentReference doccument=db.collection("Data").document("Match5");
        doccument.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@javax.annotation.Nullable DocumentSnapshot documentSnapshot, @javax.annotation.Nullable FirebaseFirestoreException e) {
                ...
                if (documentSnapshot !=null && documentSnapshot.exists()){
                    ...
                    score.setText(documentSnapshot.getData().get("score").toString());
